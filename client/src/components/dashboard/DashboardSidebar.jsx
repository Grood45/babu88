...
const DashboardSidebar = ({ open, setOpen, menuItems }) => {
  ...
  return (
    <div>
      ...
      {/* Start Menu bar */}
      <div
        className={`bg-[#222222] overflow-y-auto fixed mt-[62px] hidden md:block pb-16 ${open ? "w-64" : "w-16"
      ...
      >
        ...
        {menuItems?.map((item, index) => (
          <div key={index}>
            ...
            >
              <div
                className={`px-4 py-3 flex flex-row items-center justify-between gap-2 border-b border-gray-700 duration-300 hover:bg-[#114d3a] hover:border-l-4 hover:border-l-slate-400 ${!open && "justify-center"
                  }`}
